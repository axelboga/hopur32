...
public:
    ...
    QComboBox *dropdown_order_by_ascending;
    ...
    QComboBox *dropdown_scientist_order_by_ascending;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout_10->addWidget(dropdown_order_by);

        dropdown_order_by_ascending = new QComboBox(tab_computer);
        dropdown_order_by_ascending->setObjectName(QStringLiteral("dropdown_order_by_ascending"));
        dropdown_order_by_ascending->setEnabled(true);

        horizontalLayout_10->addWidget(dropdown_order_by_ascending);
        ...
        button_remove_computer->setIconSize(QSize(24, 24));
        ...
        horizontalLayout_7->addWidget(dropdown_scientist_order_by);

        dropdown_scientist_order_by_ascending = new QComboBox(tab_scientist);
        dropdown_scientist_order_by_ascending->setObjectName(QStringLiteral("dropdown_scientist_order_by_ascending"));

        horizontalLayout_7->addWidget(dropdown_scientist_order_by_ascending);
        ...
        computer_list_computer_connections->setEditTriggers(QAbstractItemView::NoEditTriggers);
        computer_list_computer_connections->setProperty("isWrapping", QVariant(false));
        ...
        scientist_list_computer_connections->setEditTriggers(QAbstractItemView::NoEditTriggers);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#213dbc;\">Computers and Scientists</span></p></body></html>", 0));

...
public:
    ...
    void setupUi(QDialog *AddComputerDialog)
    {
        ...
        label_add_computer->setGeometry(QRect(90, 10, 174, 19));
        layoutWidget = new QWidget(AddComputerDialog);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(60, 40, 251, 330));
        ...
        input_computer_name = new QLineEdit(layoutWidget);
        ...
        input_computer_type = new QLineEdit(layoutWidget);
        ...
        checkbox_computer_was_built = new QCheckBox(layoutWidget);
        ...
        label_computer_year_built = new QLabel(layoutWidget);
        ...
        label_error_computer_year_built = new QLabel(layoutWidget);
        ...
        input_computer_year_built = new QLineEdit(layoutWidget);
        ...
        button_add_computer = new QPushButton(layoutWidget);

...
public:
    ...
    void setupUi(QDialog *AddConnectionsDialog)
    {
        ...
        list_computers_add_connections->setEditTriggers(QAbstractItemView::NoEditTriggers);
        ...
        list_scientists_add_connections->setEditTriggers(QAbstractItemView::NoEditTriggers);
        list_scientists_add_connections->setSelectionMode(QAbstractItemView::SingleSelection);
